...
$news = array();
if ($result = $db->Execute(Statements::SELECT_LOL_NEWS . MAX_DISPLAYED_NEWS))
{
...
<head>
	...
	<META NAME="DESCRIPTION" CONTENT="Zona dedicada a League of Legends dentro de la infraestructura de la comunidad Steel Gamers.">
	<title>League of Legends - Steel Gamers</title>
