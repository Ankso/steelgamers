...
<html>
<head>
	<title>Panel de Archeage - Steel Gamers</title>
...
<div class="wrapper">
	...
	<div class="contentWrapper">
    	<div class="mainContainer">
    		...
    		<div class="latestNewsLabel <?php echo $user->IsPremium() ? " premiumLatestNewsLabel" : ""; ?>"><a class="plainLink" href="controlpanel.php">Panel de DOTA 2</a></div>
    		...
    		<div class="new">
    			...
    			<div class="newContainer">
    				<form class="formBottomBorder" action="admin.php" method="post">
                		...
                		<div class="formItem"><textarea class="ckeditor" rows="1" cols="70" name="new_title"></textarea></div>
                		<div class="formItem"><textarea class="ckeditor" rows="10" cols="70" name="new_body"></textarea></div>
