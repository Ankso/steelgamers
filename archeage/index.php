...
$_Layout = new Layout(true, true, false, false, false, true, false);
$db = new Database($DATABASES['USERS']);
$news = array();
if ($result = $db->Execute(Statements::SELECT_ARCHEAGE_NEWS . MAX_DISPLAYED_NEWS))
{
...
<head>
	...
	<title>Archeage - Steel Gamers</title>
