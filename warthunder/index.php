...
$news = array();
if ($result = $db->Execute(Statements::SELECT_WAR_THUNDER_NEWS . MAX_DISPLAYED_NEWS))
{
...
<head>
	...
	<META NAME="DESCRIPTION" CONTENT="Zona dedicada a Minecraft dentro de la infraestructura de la comunidad Steel Gamers.">
	<title>War Thunder - Steel Gamers</title>
